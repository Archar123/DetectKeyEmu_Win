...
{
	_RtlRetrieveNtUserPfn RtlRetrieveNtUserPfn = (_RtlRetrieveNtUserPfn)GetProcAddress(GetModuleHandle(L"ntdll.dll"),
		"RtlRetrieveNtUserPfn");
	if (RtlRetrieveNtUserPfn && RtlRetrieveNtUserPfn(&fnClientA, &fnClientW, &fnClientWorker) == 0) 
	{
		if (this->IsWow64) 
		{
#ifdef _M_IX86
